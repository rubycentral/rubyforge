...
That way I don't have to type that require every time I get into <tt>script/console</tt> to troubleshoot a migration failure.
...
* The GForge artifact table gets mapped into the Redmine issues table.
