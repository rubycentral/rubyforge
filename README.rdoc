...
=====================================
  activity_log               -- not migrated --
  activity_log_old           -- not migrated --
  activity_log_old_old       -- not migrated --
  api_requests               -- not migrated --  
  artifact                   issues
  ...
  frs_release
  frs_status
  gem_namespace_ownerships   -- not migrated --
  group_cvs_history
  group_history
  group_plugin
  groups                     projects
