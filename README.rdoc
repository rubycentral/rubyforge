...
* The GForge <tt>groups</tt> table gets mapped into the Redmine <tt>projects</tt> table.
* The GForge <tt>users</tt> table gets mapped into the Redmine <tt>users</tt> table and <tt>user_preferences</tt> table. 
...
* The GForge <tt>artifact_monitor</tt> table is mapped to the Redmine <tt>watchers</tt> table.  
* The GForge <tt>artifact_message</tt> table is mapped to the Redmine <tt>journals</tt> table.  
